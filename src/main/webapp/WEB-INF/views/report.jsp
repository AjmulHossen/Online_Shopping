            ...
            <ul class="sidebar navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                        ...
                        <a class="dropdown-item" href="salereportView">Sale Report</a>
            ...
            <table id="reptbl" width="350px" border="1">
                ...
                <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="" type="text" path="pid" required="true" id="pid"></form:input>
                   ...
                   <form:button id="editbuttons" type="submit" 
                                                 class="btn btn-success">Search-Productlist</form:button>
