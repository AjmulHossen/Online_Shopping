<%-- 
    ...
    Created on : Jan 9, 2019, 4:39:58 PM
    Author     : Round-36
--%>
...
<html lang="en">
    <head>
        ...
        <title>Admin - Add Order Report</title>
...
<form:form method="POST" action="orderreportView" commandName="reportInputForm">

            <table id="reptbl" width="350px" border="1">
                
                <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="" type="text" path="start_date" required="true" id="start_date"></form:input>
                                                <label for="startdate">Start_Date:</label>
                                        </div>
                                    </div>
                                                <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="" type="text" path="end_date" required="true" id="end_date"></form:input>
                                             ...
                                             <%--   <div class="form-group">
                                        <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="" type="text" path="sname" required="true" id="sname"></form:input>
                                                <label for="sname">Suplier_Name:</label>
                                        </div>
                                    </div>--%>
                
                    
                   <form:button id="editbuttons" type="submit" 
                                                 class="btn btn-success">Search</form:button>
