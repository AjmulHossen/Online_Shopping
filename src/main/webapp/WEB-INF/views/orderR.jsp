...
<form:form method="POST" action="orderView" commandName="reportInputForm">
            ...
            <table id="reptbl" width="350px" border="1">
                                        ...
                                        <div class="form-label-group">
                                            <form:input class="form-control" Placeholder="" type="text" path="oid" required="true" id="oid"></form:input>
                   ...
                   <form:button id="editbuttons" type="submit" 
                                                 class="btn btn-success">Search-Order_Details</form:button>
